...
저장소 커밋 로그를 분석해 동일 인물의 여러 계정/봇 기여를 정리한 결과입니다.

| 표기 (GitHub) | 실제 인물 | 주요 기여 |
| --- | --- | --- |
| 최민기 + mike0834 | 최민기 *(동일 이메일)* | 총괄 · 머지 · 문서 |
| kalleey030807-dotcom | 이상원 | TaskList, 타이머, 적응형 재구성, 파티 공성전 |
| Hyun0325 | 현승재 | 로그인, 통계 대시보드 |
| wlr6709 | 이동현 | 복습 / 피드백, 퀴즈 |
| Lovable + gpt-engineer-app[bot] | 팀 공동 (Lovable) | 초기 골격 · 메인 화면 (자동 생성) |

> 참고: **최민기는 팀 조장**으로서 프로젝트를 총괄하며 각 팀원의 Pull Request를 `main`에 병합(머지)하는 역할을 맡았습니다. 또한 Lovable / gpt-engineer-app[bot] 기여는 초기 프로젝트 골격을 자동 생성한 것으로, 특정 개인의 기여가 아닌 **팀 공동 결과물**입니다.
